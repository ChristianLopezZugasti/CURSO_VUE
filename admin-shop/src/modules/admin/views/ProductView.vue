<template>
          ...
          <label for="sizes" class="form-label">Tallas</label>
            ...
            <div class="flex">
                <button
                    ...
                    :key="size"
                    type="button" class="bg-blue-500 text-white p-2 rounded w-14 mr-2 flex-1">
                {{ size }}
                </button>
            </div>
  ...
  <style scoped>
  .form-label {
    @reference block text-gray-700 text-sm font-bold mb-2;
  }
  .form-control {
    @reference shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none;
  }
  </style>